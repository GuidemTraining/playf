$(document).ready(function () {
  const add_submit_btn = function () {
    ...
    var button_style = "width: 140px; padding: 10px; border: none; border-radius: 4px; background-color: #007bff; color: white; font-size: 16px; cursor: pointer; transition: background-color 0.2s;";
    ...
    if (isCompleted) {
      // If completed, disable the button and input field, and set the button color to green
