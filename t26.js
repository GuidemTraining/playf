    ...
    const add_submit_btns_to_forms = function () {
        for (let i = 1; i <= 10; i++) {
            ...
            if (isCompleted || isCorrect) {
                $input.prop('disabled', true).css('background-color', '#ccc').addClass('completed-input');
            ...
            var $button = $("<button>", {
                ...
                click: function () {
                    ...
                    if (answer === correctAnswers[i]) {
                        ...
                        $input.prop('disabled', true).attr('type', 'password').val('********').css('background-color', '#ccc').addClass('completed-input');
            ...
            $form.append($input).append($button).append($alertDiv);
        }
    };
